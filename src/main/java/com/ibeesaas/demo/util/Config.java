 ...
 */
public class Config {
    public static final String APPKEY = "mpwji4kawp";
    public static final String AK = "bY8x0yFQXpEhDJoB8OXoyMgkt6ZAEd4v";
    public static final String SK = "5Q8951MMtpklqXKL5P276cu2o2EF05Xy";
